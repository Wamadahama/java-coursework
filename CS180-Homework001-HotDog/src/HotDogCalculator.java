...
public class HotDogCalculator {
	public static void main(String[] args) {
		...
		// Get the following inputs nessecary for calculation
		// 1. How many people are attending the cookout
		// 2. How many hot dogs each person will be given

		// Initialize scanner nessecary for reading user input
		...
		// Calculate the ammount of hot dog packages that are needed
		...
		// Now that we have computed the nessecary information, print out this information to the user
